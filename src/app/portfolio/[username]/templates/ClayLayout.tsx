...
export default function ClayLayout({ portfolio, compatibility }: PortfolioTemplateProps) {
    ...
    return (
        <div className="min-h-screen bg-[#f1f3f6] text-slate-800 py-20 px-6 font-sans">
            <div className="max-w-5xl mx-auto space-y-20">
                ...
                <header className="text-center space-y-8 flex flex-col items-center">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#fafafa] rounded-[32px] shadow-[8px_8px_16px_#d1d5db,-8px_-8px_16px_#ffffff] text-sm font-bold tracking-wider">
                ...
                <div className="grid md:grid-cols-12 gap-8">
                    {/* Skills */}
                    <div className="md:col-span-4 bg-[#fafafa] rounded-[32px] shadow-[8px_8px_16px_#d1d5db,-8px_-8px_16px_#ffffff] p-8">
                    ...
                    {/* Experience */}
                    <div className="md:col-span-8 bg-[#fafafa] rounded-[32px] shadow-[8px_8px_16px_#d1d5db,-8px_-8px_16px_#ffffff] p-8 md:p-12">
                    ...
                    <section className="space-y-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            {projects.map((project, i) => (
                                <div key={i} className="bg-[#fafafa] rounded-[32px] shadow-[8px_8px_16px_#d1d5db,-8px_-8px_16px_#ffffff] p-8 flex flex-col hover:scale-[1.02] transition-transform">
